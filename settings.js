...
// App Front Page
drupalgap.settings.front = 'my_login_page';

//App lectures view page
drupalgap.settings.lectures='my_lectures';

//App home page
drupalgap.settings.home='my_home';

//App forum page
drupalgap.settings.forums='my_forums';

//App Wiki Page
drupalgap.settings.wikis='my_wikis';

//App Event Page
drupalgap.settings.events='my_events';
